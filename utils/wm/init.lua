...
module.start = function(_)
   ...
   local filters = {
      { app = "Activity Monitor", tile = true, screen="primary", space = 6 },
      ...
      { app = "DBeaver", tile = true, screen="primary", space = 5 },
      ...
      { app = "Kap", tile = false },
      { app = "Infuse", title = "Infuse", tile = false, screen="laptop", space = 1 },
      ...
      { app = "WezTerm", tile = true, screen = "primary", space = 1 },
      { app = "iTerm2", tile = true, screen = "primary", space = 2 },
      { app = "iTerm2", subrole = "AXDialog", tile = false , screen = "primary", space = 2 },
      { app = "uTools", tile = false },
      { app = "向日葵远程控制", tile = false, screen = "primary", space = 2 },
      -- { app = "信息", tile = false },
      ...
      { app = "同花顺至尊版", tile = false, screen = "primary", space = 1 },
      ...
      { app = "微信", title = "聊天", role = "AXWindow", subrole = "AXStandardWindow", tile = true , screen = "primary", space = 3 },
      { app = "企业微信", role = "AXWindow", subrole = "AXStandardWindow", eq = true, tile = true , screen = "primary", space = 3 },
      { app = "微信", role = "AXWindow", subrole = "AXStandardWindow", tile = false, eq = true },
      { app = "odonate", tile = false, screen = "laptop", space = 1 },
